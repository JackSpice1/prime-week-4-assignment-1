...
let testArray = []
function getInArray ( nameOfColor) {
  console.log ( 'in getInArray', nameOfColor );
  testArray.push( nameOfColor );
  return testArray;
}
getInArray( 'yellow' );
getInArray( 'blue' );
...
let sampleArray = ['watermelon', 'apples', 'strawberries', 'pineapple'];
console.log(find ('apples'));
